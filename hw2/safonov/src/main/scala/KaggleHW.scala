...
object KaggleHW {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val train = spark.read.format("csv")
      ...
      .load("/home/mrsandman5/bigData2020/hw2/safonov/src/main/resources/train.csv")
    ...
    val test = spark.read.format("csv")
      .option("header", "true")
      .option("inferSchema", "true")
      .load("/home/mrsandman5/bigData2020/hw2/safonov/src/main/resources/test.csv")
      .filter(col("id").isNotNull)
      .filter(col("text").isNotNull)
      .select("id", "text")
    ...
    val sample = spark.read.format("csv")
      .option("header", "true")
      .option("inferSchema", "true")
      .load("/home/mrsandman5/bigData2020/hw2/safonov/src/main/resources/sample_submission.csv")
      .select("id")
    ...
    result.join(sample, sample.col("id").equalTo(result.col("id")), "right")
      ...
      .option("header", "true")
      .option("inferSchema", "true")
      .save("/home/mrsandman5/bigData2020/hw2/safonov/src/main/resources/my_result.csv")

    model.write.overwrite
      .save("/home/mrsandman5/bigData2020/hw2/safonov/model/")
  }
}